    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VoiceChannelSessions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VoiceChannelSessions_Channels_ChannelId",
                        column: x => x.ChannelId,
                        principalTable: "Channels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VoiceChannelSessions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServerMembers_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VoiceChannelSessions_ChannelId_UserId",
                table: "VoiceChannelSessions",
                columns: new[] { "ChannelId", "UserId" });

            migrationBuilder.CreateIndex(
                name: "IX_VoiceChannelSessions_IsActive",
                table: "VoiceChannelSessions",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_VoiceChannelSessions_UserId",
                table: "VoiceChannelSessions",
                column: "UserId");
        }
